...
# Main path 
dir_name = "data/i29/strain/strain_test"
...
# Measurement data
strain_shift = list()
strain = [30,40,50,60,70,60,50,40,30]
order = ['30','40','50','60','70','60d','50d','40d','30d']
...
for dir in dir_list:
    ...
    if file_prefix_list:
        for i,file_name in enumerate(file_prefix_list):
            ...
            meas_single = dfreader.getSingleMeasurement(1.15, 1).item(0)
